...
<div x-data="setup()" :class="{ 'dark': isDark }">
  <Employeesidebar />
    <div class=" body-color min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">

      <div class="h-full top-0 ml-14  md:ml-64 z-10">

        <!-- Time Cards -->
        <div class="grid grid-cols-1 top-0 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          <div class="bg-becolor dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-bemagenta dark:border-gray-600 text-white font-medium group hover:bg-white hover:text-green-700">
            <div class="flex justify-center items-center w-20 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:h-full group-hover:w-1/2">
                <p class="text-green-700 font-bold text-sm">LATE</p>
            </div>
            <div class="text-right">
              <p class="text-base font-bold">0 hrs 0 mins</p>
            </div>
          </div>
          <div class="bg-becolor dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-bemagenta dark:border-gray-600 text-white font-medium group hover:bg-white hover:text-green-700">
            <div class="flex justify-center items-center w-32 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:h-full group-hover:w-1/2">
                <p class="text-green-700 font-bold text-sm">UNDERTIME</p>
            </div>
            <div class="text-right">
              <p class="text-base font-bold">0 hrs 0 mins</p>
            </div>
          ...
          <div class="bg-becolor dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-bemagenta dark:border-gray-600 text-white font-medium group hover:bg-white hover:text-green-700">
            <div class="flex justify-center items-center w-32 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:h-full group-hover:w-1/2">
                <p class="text-green-700 font-bold text-sm">OVERTIME</p>
            </div>
            <div class="text-right">
              <p class="text-base font-bold">0 hrs 0 mins</p>
            </div>
          ...
          <div class="bg-becolor dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-bemagenta dark:border-gray-600 text-white font-medium group hover:bg-white hover:text-green-700">
            <div class="flex justify-center items-center w-44 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:h-full group-hover:w-1/2">
                <p class="text-green-700 font-bold text-sm">HOURS RENDERED</p>
            </div>
            <div class="text-right">
              <p class="text-base font-bold">0 hrs 0 mins</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 p-4 gap-4">
            ...
            <div class="rounded-t mb-0 px-0 border-0">
              <div class="flex flex-wrap px-4 py-2">
                <div class="relative w-full max-w-full flex-grow flex-1">
                  <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">TODAY<br>January</h3>
                </div>
                <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                  <button class="bg-becolor dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Check In</button>
                  <button class="bg-bemagenta dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Check Out</button>
                </div>
              </div>
                ...
                <table class="items-center w-full bg-transparent border-collapse">
                  ...
                  <tbody>
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">AM IN</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ amIn }}</td>
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">LB OUT</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ lbOut }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">LB IN</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ lbIn }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">CB OUT</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ cbOut }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">CB IN</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ cbIn }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">PM OUT</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ pmOut }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                          <span class="mr-2">30%</span>
                          <div class="relative w-full">
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">DURATION</th>
                      <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ duration }}</td>
                      <!-- <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div class="flex items-center">
                          <span class="mr-2">30%</span>
                          <div class="relative w-full">
              ...
              <div class="grid">
                <button class="bg-becolor text-sm place-self-center dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 font-bold uppercase px-5 py-3 rounded outline-none focus:outline-none ease-linear transition-all duration-150">Manual Check in</button>
              </div>
            </div>
          </div>
          <!-- ./Daily Time Card  -->
          ...
          <!-- Recent Activities -->
          <div class="relative flex flex-col col-span-3 min-w-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
            <!-- <div class="rounded-t mb-0 px-0 border-0">
              ...
              <table class="w-full">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <th class="py-3">AM IN</th>
                    <th class="py-3">LB OUT</th>
                    <th class="py-3">LB IN</th>
                    <th class="py-3">CB OUT</th>
                    <th class="py-3">CB IN</th>
                    <th class="py-3">PM OUT</th>
                    <th class="py-3">DURATION</th>
                  </tr>
                </thead>
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  <tr class="bg-gray-50 dark:bg-gray-800 text-left hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="py-3">
                    ...
                    <td class="py-3 text-sm">7:30 a.m.</td>
                    <td class="py-3 text-sm">
                        12:00 p.m.
                      <!-- <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> Approved </span> -->
                    </td>
                    <td class="py-3 text-sm">01:00 p.m.</td>
                    <td class="py-3 text-sm">04:00 p.m.</td>
                    <td class="py-3 text-sm">04:20 p.m.</td>
                    <td class="py-3 text-sm">06:00 p.m.</td>
                    <td class="py-3 text-sm">10 hrs 30 mins</td>
                  </tr>
                  <tr class="bg-gray-50 dark:bg-gray-800 text-left hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="py-3">
                      <div class="py-3 text-sm">
